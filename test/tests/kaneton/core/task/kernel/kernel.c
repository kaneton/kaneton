 ...
 * updated       julien quintard   [sun jan 30 21:17:16 2011]
 */
...
#define KERNEL_SHARED_ADDRESS 0x0FFF1000
...
{
  *((t_uint32*) KERNEL_SHARED_ADDRESS) = 42;
...
void			test_core_task_kernel(void)
{
  ...
  if (thread_reserve(_kernel.task,
		     ...
		     (t_vaddr)test_core_task_kernel_thread_01,
  ...
  if (as_copy(_kernel.as, (t_vaddr) test_core_task_kernel_thread_02,
              as, r->address,
