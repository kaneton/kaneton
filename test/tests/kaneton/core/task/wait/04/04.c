 ...
 * updated       julien quintard   [sat dec 18 22:39:22 2010]
 */
...
void			test_core_task_wait_04(void)
{
  ...
  ctx.pc = (t_vaddr)test_core_task_wait_04_content_00;
  ...
  ctx.sp = o->stack + o->stacksz - 16;
  ctx.pc = (t_vaddr)test_core_task_wait_04_content_01;
  ...
  ctx.sp = o->stack + o->stacksz - 16;
  ctx.pc = (t_vaddr)test_core_task_wait_04_thread;
