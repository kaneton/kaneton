 ...
 * license       kaneton
 *
 * file          /home/mycure/kane...est/tests/kaneton/core/task/wait/01/01.c
 *
 * created       julien quintard   [sun oct 17 14:37:04 2010]
 * updated       julien quintard   [sun jan 30 21:17:54 2011]
 */
...
void			test_core_task_wait_01_thread(void)
{
...
void			test_core_task_wait_01_content_00(void)
{
  ...
  if (task_exit(task_01, 84) != STATUS_OK)
  ...
  TEST_SIGNATURE(09iffcw0f9i3f98ug);

  while (1)
    ;
}

void			test_core_task_wait_01_content_01(void)
{
  s_wait		wait;
  i_cpu			cpu;

  if (task_wait(thread_01, task_01, WAIT_STATE_DEATH, &wait) != STATUS_OK)
  ...
  TEST_SIGNATURE(ncuiw9f329ri0g2w3r2);
...
void			test_core_task_wait_01(void)
{
  i_as			as;
  i_thread		thread;
  i_cpu			cpu;
  ...
  if (thread_reserve(_kernel.task,
		     ...
		     (t_vaddr)test_core_task_wait_01_content_00,
  ...
  if (thread_reserve(_kernel.task,
		     ...
		     THREAD_STACK_ADDRESS_NONE,
                     THREAD_STACK_SIZE_LOW,
		     (t_vaddr)test_core_task_wait_01_content_01,
  ...
  if (as_copy(_kernel.as, (t_vaddr) test_core_task_wait_01_thread,
              as, r->address,
  ...
  TEST_SIGNATURE(jcvewf8923r9g093g0ig);
