 ...
 * updated       julien quintard   [fri jan 14 23:05:41 2011]
 */
...
void			test_core_task_wait_02(void)
{
  ...
  ctx.pc = (t_vaddr)test_core_task_wait_02_content_00;
  ...
  ctx.sp = o->stack + o->stacksz - 16;
  ctx.pc = (t_vaddr)test_core_task_wait_02_content_01;
  ...
  ctx.sp = o->stack + o->stacksz - 16;
  ctx.pc = (t_vaddr)test_core_task_wait_02_thread;
