 ...
 * updated       julien quintard   [fri jan 14 23:05:56 2011]
 */
...
void			test_core_task_wait_05(void)
{
  ...
  ctx.pc = (t_vaddr)test_core_task_wait_05_content_00;
  ...
  ctx.sp = o->stack + o->stacksz - 16;
  ctx.pc = (t_vaddr)test_core_task_wait_05_content_01;
  ...
  ctx.sp = o->stack + o->stacksz - 16;
  ctx.pc = (t_vaddr)test_core_task_wait_05_thread;
