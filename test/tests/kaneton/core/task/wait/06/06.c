 ...
 * updated       julien quintard   [sun jan 30 21:27:42 2011]
 */
...
void			test_core_task_wait_06(void)
{
  ...
  if (thread_reserve(_kernel.task,
		     ...
		     (t_vaddr)test_core_task_wait_06_content_00,
  ...
  if (thread_reserve(_kernel.task,
		     ...
		     THREAD_STACK_ADDRESS_NONE,
                     THREAD_STACK_SIZE_LOW,
		     (t_vaddr)test_core_task_wait_06_content_01,
  ...
  if (as_copy(_kernel.as, (t_vaddr) test_core_task_wait_06_thread,
              as, r->address,
