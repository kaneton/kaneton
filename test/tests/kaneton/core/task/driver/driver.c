 ...
 * license       kaneton
 *
 * file          /home/mycure/kane.../tests/kaneton/core/task/driver/driver.c
 *
 * created       julien quintard   [sun oct 17 14:37:04 2010]
 * updated       julien quintard   [sun jan 30 21:17:42 2011]
 */
...
#define DRIVER_SHARED_ADDRESS 0x0FFF1000
...
void			test_core_task_driver_thread_01(void)
{
  i_cpu			cpu;
  ...
  TEST_SIGNATURE(vnweoiwf30f9i3gi3);
...
void			test_core_task_driver_thread_02(void)
{
  *((t_uint32*) DRIVER_SHARED_ADDRESS) = 42;

  while (1)
    ;
}

void			test_core_task_driver(void)
{
  i_thread              thread_02;
  i_task		task;
  i_as			as;
  ...
  if (thread_reserve(_kernel.task,
		     ...
		     (t_vaddr)test_core_task_driver_thread_01,
  ...
  if (as_copy(_kernel.as, (t_vaddr) test_core_task_driver_thread_02,
              as, r->address,
  ...
  TEST_SIGNATURE(90dfi23jwmelcewgkweg);
