 ...
 * license       kaneton
 *
 * file          /data/mycure/repo...E/test/tests/kaneton/core/set/ll/08/08.c
 *
 * created       julien quintard   [sun oct 17 14:37:04 2080]
 * updated       julien quintard   [mon nov 29 19:22:55 2010]
 */
...
void			test_core_set_ll_08(void)
{
  ...
  if (set_reserve(ll, SET_OPTION_FREE, sizeof(t_id), &id) != ERROR_OK)
    TEST_ERROR("[set_reserve] error");
  ...
  TEST_SIGNATURE(skldv4io3g30pw21s);
