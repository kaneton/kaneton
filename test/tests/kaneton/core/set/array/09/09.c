 ...
 * license       kaneton
 *
 * file          /home/mycure/kane...est/tests/kaneton/core/set/array/09/09.c
 *
 * created       julien quintard   [sun oct 17 14:37:04 2090]
 * updated       julien quintard   [sun dec  5 16:19:10 2010]
 */
...
void			test_core_set_array_09(void)
{
  ...
  if (set_reserve(array, SET_OPTION_SORT, 4, sizeof (t_id), &id) != STATUS_OK)
  ...
  TEST_SIGNATURE(30weasdf90wg43hg34h);
