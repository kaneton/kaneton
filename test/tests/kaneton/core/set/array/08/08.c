 ...
 * license       kaneton
 *
 * file          /home/mycure/kane...est/tests/kaneton/core/set/array/08/08.c
 *
 * created       julien quintard   [sun oct 17 14:37:04 2080]
 * updated       julien quintard   [thu dec 16 12:18:07 2010]
 */
...
void			test_core_set_array_08(void)
{
  ...
  if (set_reserve(array, SET_OPTION_FREE, 4, sizeof (t_id), &id) != STATUS_OK)
    TEST_ERROR("[set_reserve] error");
