...
void			test_core_time_reserve_03_handler_01(void)
{
  timed |= (1 << 0);
}

void			test_core_time_reserve_03_handler_02(void)
{
  timed |= (1 << 1);
}

void			test_core_time_reserve_03_handler_03(void)
{
  timed |= (1 << 2);
}

void			test_core_time_reserve_03_handler_04(void)
{
  timed |= (1 << 3);
}
...
void			test_core_time_reserve_03(void)
{
  i_thread		thread;
  o_thread*		o;
  ...
  ctx.pc = (t_vaddr)test_core_time_reserve_03_content;
