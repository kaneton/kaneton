 ...
 * updated       julien quintard   [sun nov 21 00:02:42 2010]
 */
...
void			test_ia32_event_exception_03_handler(t_id	id)
{
  thrown++;
}

void			test_ia32_event_exception_03(void)
{
  TEST_ENTER();

  if (event_reserve(3,
		    EVENT_FUNCTION,
		    EVENT_HANDLER(test_ia32_event_exception_03_handler),
		    0) != ERROR_NONE)
