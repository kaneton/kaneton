 ...
 * updated       julien quintard   [sun nov 21 00:06:09 2010]
 */
...
void			test_ia32_event_exception_07_handler(t_id	id,
							     t_vaddr	address,
							     t_uint32	error)
{
  i_segment		segid;
...
void			test_ia32_event_exception_07(void)
{
  t_uint8*		ptr;
  i_segment		segid;
  i_region		regids[10];
  ...
  if (event_reserve(14,
		    EVENT_FUNCTION,
		    EVENT_HANDLER(test_ia32_event_exception_07_handler),
		    0) != ERROR_NONE)
