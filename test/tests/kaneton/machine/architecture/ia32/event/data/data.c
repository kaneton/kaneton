 ...
 * updated       julien quintard   [sun nov 21 00:00:08 2010]
 */
...
void			test_ia32_event_data_handler(t_id	id,
						     t_vaddr	pv)
{
  thrown = 1;
...
void			test_ia32_event_data(void)
{
  TEST_ENTER();

  if (event_reserve(3,
		    EVENT_FUNCTION,
		    EVENT_HANDLER(test_ia32_event_data_handler),
