 ...
 * license       kaneton
 *
 * file          /home/mycure/kane.../glue/ibm-pc.ia32/task/service/service.c
 *
 * created       julien quintard   [sun oct 17 14:37:04 2030]
 * updated       julien quintard   [sat nov 20 23:13:33 2010]
 */
...
void			test_ibmpc_ia32_task_service_thread(void)
{
  t_uint32		cs;
...
void			test_ibmpc_ia32_task_service_content(void)
{
  i_task		tsk;
  t_id			thread;
  t_uint32		start;
  ...
  ctx.pc = (t_vaddr)test_ibmpc_ia32_task_service_thread;
...
void			test_ibmpc_ia32_task_service(void)
{
  i_thread		thread;
  o_thread*		o;
  t_thread_context	ctx;
  ...
  ctx.sp = o->stack + o->stacksz - 16;
  ctx.pc = (t_vaddr)test_ibmpc_ia32_task_service_content;
