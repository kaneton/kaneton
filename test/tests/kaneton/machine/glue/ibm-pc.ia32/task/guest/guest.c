 ...
 * license       kaneton
 *
 * file          /home/mycure/kane...hine/glue/ibm-pc.ia32/task/guest/guest.c
 *
 * created       julien quintard   [sun oct 17 14:37:04 2040]
 * updated       julien quintard   [sat nov 20 23:12:55 2010]
 */
...
void			test_ibmpc_ia32_task_guest_thread(void)
{
  t_uint32		cs;
...
void			test_ibmpc_ia32_task_guest_content(void)
{
  i_task		tsk;
  t_id			thread;
  t_uint32		start;
  ...
  ctx.pc = (t_vaddr)test_ibmpc_ia32_task_guest_thread;
...
void			test_ibmpc_ia32_task_guest(void)
{
  i_thread		thread;
  o_thread*		o;
  t_thread_context	ctx;
  ...
  ctx.sp = o->stack + o->stacksz - 16;
  ctx.pc = (t_vaddr)test_ibmpc_ia32_task_guest_content;
