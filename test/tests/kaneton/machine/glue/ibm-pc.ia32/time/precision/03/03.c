 ...
 * license       kaneton
 *
 * file          /home/mycure/kane.../glue/ibm-pc.ia32/time/precision/03/03.c
 *
 * created       julien quintard   [sun oct 17 14:37:03 2030]
 * updated       julien quintard   [sat nov 20 23:29:17 2010]
 */
...
void			test_ibmpc_ia32_time_precision_03_handler(t_id	  id,
								  t_vaddr data)
{
  timed = 1;
...
void			test_ibmpc_ia32_time_precision_03_content(void)
{
  t_uint32		start;
  i_timer		tid;

  if (timer_reserve(TIMER_FUNCTION,
		    TIMER_HANDLER(test_ibmpc_ia32_time_precision_03_handler),
		    0,
		    1000,
...
void			test_ibmpc_ia32_time_precision_03(void)
{
  i_thread		thread;
  o_thread*		o;
  ...
  ctx.pc = (t_vaddr)test_ibmpc_ia32_time_precision_03_content;
