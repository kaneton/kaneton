 ...
 * license       kaneton
 *
 * file          /home/mycure/kane...t/tests/kaneton/segment/multiple/02/02.c
 *
 * created       julien quintard   [sun oct 17 14:37:04 2010]
 * updated       julien quintard   [wed oct 20 16:34:42 2010]
 */
...
void			test_segment_multiple_02(void)
{
  i_task		task;
  i_as			as;
  i_segment		seg[4];
  ...
  MULTIPLE_ALLOCATE(as, 3, seg + 2);
  MULTIPLE_ALLOCATE(as, 7, seg + 1);
