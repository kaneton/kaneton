...
# FIX by buckman
KERNEL_HEADERS=$(top_builddir)libc/sysdeps/kaneton/kernel
...
CFLAGS += -O2 -fomit-frame-pointer $(XARCH_CFLAGS)
endif
ifeq ($(DOSTRIP),y)
LDFLAGS += -s
else
...
CFLAGS	+=	-I$(top_srcdir)../libkaneton/include -I$(top_srcdir)crt/include -I$(top_srcdir)../../kaneton/include
