...
% updated       julien quintard   [fri may 23 20:17:55 2008]
%
...
% this command should encapsulates the whole text e.g
...
% type
%
% this command is can only be used in the function() command and is used
