...
\begin{itemize}
  ...
  \item
    ...
    manager to be able to manage physical memory in a very elegant way.
  \item
    \textbf{k3}: this project introduces the development of some drivers
    (keyboard, timer, demonstration shell) and the development of the
    region manager to provide virtual memory operations. Moreover the
    students will have to design and implement a generic events interface.
    A document will have to be provided by each group describing the
