...
% updated       matthieu bucchianeri   [mon nov  5 21:42:29 2007]
%
...
\begin{frame}
  ...
  them, a special mechanism called ``sets'' is used for containers.
...
\begin{frame}
  ...
  In addition, having kaneton running on two different platforms means
...
\begin{frame}
  ...
  Recruits will have to appropriate to themrselves the currently existing
