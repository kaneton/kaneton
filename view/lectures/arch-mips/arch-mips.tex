...
%% updated       julien quintard   [thu dec  1 18:58:12 2005]
%%
...
\pgfdeclareimage[interpolate=true,width=143pt,height=103pt]
                {software-pipeline}
...
\begin{frame}[containsverbatim]
  ...
  some instructions are totally needless.
...
\begin{frame}
  ...
  We can view the pipeline from two different points of view:
...
\begin{frame}
  ...
  if you take the bus, the ratio is about: 30/3000.
