...
%% updated       julien quintard   [tue nov 29 12:25:49 2005]
%%
...
\pgfdeclareimage[interpolate=true,width=175pt,height=171pt]
...
\pgfdeclareimage[interpolate=true,width=298pt,height=178pt]
                {strlen-part-1}
		{figures/strlen-part-1}
\pgfdeclareimage[interpolate=true,width=218pt,height=149pt]
                {strlen-part-2}
...
\begin{frame}
  ...
  The dependencies detectors will check if two consecutive instructions
  are dependent.
...
\begin{frame}[containsverbatim]
  ...
  Let's enumerate some instruction sequence to isolate dependency
  cases.
...
\begin{frame}
  ...
  There are dependencies of order: \textbf{1}, \textbf{2}, \textbf{3}.
...
\begin{frame}
  \frametitle{Exercice - Strlen Part One}
...
\begin{frame}
  \frametitle{Exercice - Strlen Part Two}
...
\begin{frame}
  \frametitle{Exercice - Strlen Part Three}
...
\begin{frame}
  \frametitle{Exercice - Strlen Part Four}
...
% nous avons vu que le reordonnancement permettait deja d'optimiser
...
\begin{thebibliography}{2}
  ...
  \bibitem{R2000-R3000}
    ...
    \newblock Including R2000/R2010 and R3000/R3010
    \newblock By Gerry Kane

  \bibitem{R4000}
    MIPS RISC Architecture
    \newblock Including the R2000, R3000, R6000 ad the new R4000
