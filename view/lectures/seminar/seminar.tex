...
%% updated       julien quintard   [fri dec  2 16:22:29 2005]
%%
...
\begin{frame}
  ...
  interesting by operating systems internals.
\end{frame}
...
\begin{frame}
  ...
  doubly linked-list , hash tables, trees etc.. data structures to
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    \item
      ...
      manager for its architecture so it can optimise every data structure
    ...
    \item
      Define a generic interface in which each architecture must fill into.
      ...
      it may exist an architecture does not fitting in this interface.
    \item
      ...
      The problem is that it may be some problems where the architecture
...
\begin{frame}
  ...
  needed like building a new page directory and linking it the the
...
\begin{frame}
  ...
  Every developer can validate his modifications running unitary/regression
