...
le cache qui gère tout les objets de type \verb+region_t+.  Ecrivez la fonction
...
\item Quels types d'objets ne peuvent pas être alloué le slab allocator de ChicheOS ?
