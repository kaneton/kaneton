...
% updated       julien quintard   [thu may 28 12:54:39 2009]
%
...
\section{Premi\`ere Partie
         {\hfill{} \normalfont{\scriptsize{30 minutes}}}}

\subsection{Boot
            {\hfill{} \normalfont{\scriptsize{1 point}}}}

D\'ecrivez rapidement les \'etapes principales effectu\'ees par un bootloader.
...
\subsection{M\'emoire virtuelle
            \normalfont{{\hfill{} \scriptsize{1 point}}}}
...
\section{Deuxi\`eme Partie
         \normalfont{{\hfill{} \scriptsize{50 minutes}}}}
...
\section{Troisi\`eme Partie
         \normalfont{{\hfill{} \scriptsize{45 minutes}}}}

\subsection{Pr\'eriph\'erique
...
\subsection{S\'ecurit\'e
            \normalfont{{\hfill{} \scriptsize{2.5 points}}}}
