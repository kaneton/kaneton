...
% updated       julien quintard   [thu may 22 16:19:53 2008]
%
...
A \term{module} represents a passive execution entity in main memory.
...
necessary. For example a very used program like \location{/bin/ls} will
...
A \term{program} is the lowest privileged task on the system.
