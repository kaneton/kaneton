...
\begin{itemize}
  ...
  \item
    Pipeline: we will see the MIPS pipeline and pipeline inherent problems
    and limitations.
  \item
...
\begin{enumerate}
  \item
    ...
    instruction formats and to inherent limitations.
  \item
  ...
  \item
    The next instruction address computation problem and the delay slot.
    Then, study of branch instruction and their problems and limitations.
    Some exercises to pratice.
  \item
    Introduction to instruction dependencies.
\end{enumerate}
