...
\note{A smart idea would be to add a \textit{next} field in the
...
\note{Once the segment manager is initialized, the core segments
...
\note{Once the regions manager is initialized, the core regions
  get useless, so they can be released.}
