...
% updated       julien quintard   [tue may 20 17:30:06 2008]
%
...
pure {\LaTeX} documents as well as \name{Beamer} documents.

Every time the \verb|\item| element is used, for instance in \code{itemize},
or \code{enumerate} environments, the text related to the item must be
