...
% updated       julien quintard   [tue jun 26 16:37:47 2007]
%
...
The development environment is composed of profiles including a \textit{host}
...
The \textit{FOO} variable first takes the initial value \textit{bar}. Then,
...
\function{env\_assemble-asm}{(\argument{object file},
                              ...
                              \argument{options})}
         {
	   This function assembles an \argument{asm file}.
...
\function{path}{(\argument{path},
	   ...
	   specify which information the caller is interested in. The option
           \textit{OPTION\_EXIST} indicates whether the \argument{path} object
           exists or not.
	 }
