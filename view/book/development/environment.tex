...
% updated       julien quintard   [fri may 25 18:14:30 2007]
%
...
\function{file}{(\argument{file},
                 \argument{options})}
         {
	   This function returns the content of the \argument{file} with
	   the \textit{OPTION\_READ} option or write the content with the
	   option \textit{OPTION\_WRITE}.
	 }
