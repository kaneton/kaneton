...
% updated       julien quintard   [tue may 20 17:05:31 2008]
%
...
This mailing-list is actually a \name{Google Group}. The kaneton
project relies on four distinct communication groups:

\begin{itemize}
  \item
    \term{kaneton-announcements} which is used to communicate with all the
  ...
  \item
    \term{kaneton-developers} is dedicated to the communication between the
  ...
  \item
    \term{kaneton-teachers} is reserved to people involved in teaching
  ...
  \item
    \term{kaneton-students} can be used in an absolutely free-way by
...
The \name{kaneton-students} mailing-list must be used carefully as well. As
