...
\function{t\_error}{ia32\_map\_chunk}{\type{t\_vaddr} \argument{v},
				      \type{t\_paddr} \argument{p},
				      \type{void*} \argument{alloc}}
{
  This function takes a preallocated region object in \argument{alloc}.
  It will fill this object and create a mapping for the virtual address
  \argument{v} to the physical address \argument{p} in the kernel address
  space, and inject this region in the set of regions of the kernel as.
}

\function{t\_error}{ia32\_unmap\_chunk}{\type{t\_vaddr} \argument{v}}
{
  This function unmaps a page that has previously been mapped with the
  map\_chunk function. The parameter \argument{v} specifies the virtual
