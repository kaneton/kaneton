...
% updated       julien quintard   [tue feb  8 22:07:15 2011]
%
...
schedulers, one for each \name{CPU}, each of which is reponsible for the
...
and when returning from the interrupt---through the \code{iret} assembly
...
\name{k3} to comply with this design. Therefore, whenever an interrupt is
...
The function \code{architecture\_context\_destory()} does the opposite by
...
stack or pile is given by the structure \code{as\_context}. Once again,
