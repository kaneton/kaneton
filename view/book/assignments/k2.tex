...
% updated       julien quintard   [mon feb  7 12:55:46 2011]
%
...
Although the core as manager is complete, students should definitely look at
it.
...
the \name{Intel} segmentation model while the glue region manager relies on
