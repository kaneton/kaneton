...
\item
  \emph{No} register other than \argument{\%eax} shall be modified unless explicitly requested.
\item
...
\function{itoa}{}
{
  ...
  stored in \argument{\%si}. Use this function to check your malloc.
}
...
Be careful, the value correspond to the second sector is ``2'' (and not 1), because
