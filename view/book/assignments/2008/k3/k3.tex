...
The role of the scheduler is to allocate cpu's resources to the
...
\function{scheduler\_update}{(i\_thread \argument{thread})}
{
  ...
  \argument{thread} in its internal data structures because
...
\function{scheduler\_switch}{(void)}
{
  ...
  \function{ia32\_scheduler\_switch}{(i\_thread \argument{elected})}
  {
