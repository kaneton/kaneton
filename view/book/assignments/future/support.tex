...
% updated       julien quintard   [fri nov 28 11:26:43 2008]
%
...
\name{kaneton} educational project. Note that students are welcome to add
contents to this wiki.

The \name{kaneton} \name{Wiki} can be accessed through the \name{Wiki} section
of the \name{kaneton} website:

\begin{center}
  \location{http://kaneton.opaak.org}
\end{center}
