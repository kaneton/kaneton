...
% updated       julien quintard   [mon may 19 22:04:47 2008]
%
...
The \code{get()} function is used for retrieving a kaneton object given its
...
Finally, every manager provides an \code{attribute()} function which
...
The \location{libc/} directory contains the microkernel-specific C library
