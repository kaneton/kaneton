...
% updated       julien quintard   [fri jan 30 02:07:14 2009]
%
...
\begin{frame}
  ...
  from \name{k1} to \name{k4} are done in groups of \term{two} students.
...
\begin{frame}
  ...
  As for \name{Tiger}, every stage depends on the previous one.
