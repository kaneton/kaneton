...
%% updated       julien quintard   [mon mar  6 02:11:21 2006]
%%
...
The Figure \ref{overview_distributed-operating-system} illustrates
these communications.

\begin{figure}[h]
  \label{overview_distributed-operating-system}
  \begin{center}
...
On the Figure \ref{overview_distributed-operating-system}, the machine
...
The Figure \ref{overview_microkernel} illustrates a microkernel
view with different layers.

\begin{figure}[h]
  \label{overview_microkernel}
  \begin{center}
...
On the Figure \ref{overview_microkernel}, the \textit{vfs} server can
...
To conclude, the Figure \ref{overview_kaneton} illustrates the kaneton
microkernel internal managers.

\begin{figure}[h]
  \label{overview_kaneton}
  \begin{center}
