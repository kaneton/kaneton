...
% license       kaneton
%
% file          /home/mycure/kane.../memory-management/memory-management.tex
%
% created       julien quintard   [wed may 16 19:25:35 2007]
% updated       julien quintard   [wed may 16 19:29:29 2007]
%
...
\pgfdeclareimage[interpolate=true,width=286pt,height=180pt]
                {tlb-powerpc}
		{figures/tlb-translation-setup-mpc745x-ppc}
...
\pgfdeclareimage[interpolate=true,width=166pt,height=70pt]
                {false-sharing}
		{figures/false-sharing}
\pgfdeclareimage[interpolate=true,width=192pt,height=170pt]
                {hoard}
		{figures/hoard}
...
\pgfdeclareimage[interpolate=true,width=204pt,height=170pt]
                {swap}
		{figures/swap}
\pgfdeclareimage[interpolate=true,width=294pt,height=140pt]
                {swap-out-step1}
		{figures/swap-out-step1}
\pgfdeclareimage[interpolate=true,width=294pt,height=140pt]
                {swap-out-step2}
		{figures/swap-out-step2}
\pgfdeclareimage[interpolate=true,width=294pt,height=140pt]
                {swap-step1}
		{figures/swap-step1}
\pgfdeclareimage[interpolate=true,width=294pt,height=140pt]
...
% -)
\begin{frame}
  \frametitle{PowerPC example}

  \begin{center}
   \pgfuseimage{tlb-powerpc}
  \end{center}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \hline
    MIPS R10000 & Instruction & 8 entries, fully associative \\
    \hline
    MIPS R10000 & Data & 64 entries, fully associative \\
    \hline
    \end{tabular}
  \end{itemize}
\end{frame}
