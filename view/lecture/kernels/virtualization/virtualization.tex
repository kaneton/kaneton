...
\only<1> {\includegraphics[height=6cm]{figures/shadow_page_table_1}}
\only<2> {\includegraphics[height=6cm]{figures/shadow_page_table_2}}
\only<3> {\includegraphics[height=6cm]{figures/shadow_page_table_3}}
\only<4> {\includegraphics[height=6cm]{figures/shadow_page_table_4}}
\only<5> {\includegraphics[height=6cm]{figures/shadow_page_table_5}}
\only<6> {\includegraphics[height=6cm]{figures/shadow_page_table_6}}
\only<7> {\includegraphics[height=6cm]{figures/shadow_page_table_7}}
\only<8> {\includegraphics[height=6cm]{figures/shadow_page_table_8}}
\only<9> {\includegraphics[height=6cm]{figures/shadow_page_table_9}}
\only<10>{\includegraphics[height=6cm]{figures/shadow_page_table_10}}
\only<11>{\includegraphics[height=6cm]{figures/shadow_page_table_11}}
\only<12>{\includegraphics[height=6cm]{figures/shadow_page_table_12}}
\only<13>{\includegraphics[height=6cm]{figures/shadow_page_table_13}}
\only<14>{\includegraphics[height=6cm]{figures/shadow_page_table_14}}
\end{overlayarea}
\end{frame}
