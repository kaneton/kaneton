...
% license       kaneton
%
% file          /home/mycure/kane...nels/task-scheduling/task-scheduling.tex
%
% created       julien quintard   [wed may 16 19:33:50 2007]
% updated       julien quintard   [wed may 16 19:34:37 2007]
%
...
\pgfdeclareimage[interpolate=true,width=45pt,height=180pt]
                {linux-as}
		{figures/linux-as}

\pgfdeclareimage[interpolate=true,width=242pt,height=180pt]
                {linux-kernel-as}
		{figures/linux-kernel-as}
...
\pgfdeclareimage[interpolate=true,width=285pt,height=150pt]
                {lifecycle-unix}
		{figures/lifecycle-unix}
\pgfdeclareimage[interpolate=true,width=300pt,height=150pt]
                {lifecycle-windows}
		{figures/lifecycle-windows}
\pgfdeclareimage[interpolate=true,width=300pt,height=150pt]
                {lifecycle-kaneton}
		{figures/lifecycle-kaneton}
