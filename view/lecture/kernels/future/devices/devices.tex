...
\begin{center}
\begin{overlayarea}{10cm}{10cm}
\only<1>{\includegraphics[height=150pt,width=302pt]{pic/dma-step1}}
\only<2>{\includegraphics[height=150pt,width=302pt]{pic/dma-step2}}
\only<3>{\includegraphics[height=150pt,width=302pt]{pic/dma-step3}}
\end{overlayarea}
\end{center}
\end{frame}
