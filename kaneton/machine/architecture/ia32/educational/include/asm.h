...
// XXX a bouger dans io.h?

#define ARCHITECTURE_IO_IN_8	INB
#define ARCHITECTURE_IO_IN_16	INW
#define ARCHITECTURE_IO_IN_32	INL
#define ARCHITECTURE_IO_OUT_8	OUTB
#define ARCHITECTURE_IO_OUT_16	OUTW
#define ARCHITECTURE_IO_OUT_32	OUTL
