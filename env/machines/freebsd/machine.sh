...
## project
##
## file          /home/ohmer/projects/kaneton/env/machines/freebsd/machine.sh
##
## created       julien quintard   [fri feb 11 02:08:31 2005]
## updated       matthieu michaud   [thu feb  9 13:48:09 2006]
##
...
print()
{
  ...
  if [ "${_DISPLAY_}" = "color" ] ; then
    case "$color" in
      "red")
        ${_ECHO_} -e ${options} '\033[0;31m'"\033[1m${text}\033[0m"
        ;;

      "green")
        ${_ECHO_} -e ${options} '\033[0;32m'"\033[1m${text}\033[0m"
        ;;

      "yellow")
        ${_ECHO_} -e ${options} '\033[0;33m'"\033[1m${text}\033[0m"
        ;;

      "blue")
        ${_ECHO_} -e ${options} '\033[0;34m'"\033[1m${text}\033[0m"
        ;;

      "white")
        ${_ECHO_} -e ${options} '\033[0;37m'"\033[1m${text}\033[0m"
        ;;
