...
%% last update   Tue Oct  4 15:09:47 2005   mycure
%%

%% XXX todo
%% cases study
%% corriger les fautes, IL Y EN A
...
\begin{frame}
  ...
  \begin{center}
    \pgfuseimage{upmc} \hspace{0.1cm} \pgfuseimage{lip6} \hspace{0.1cm}
...
\begin{frame}[containsverbatim]
  ...
  the compiling time, gcc will warn an error because this is an syntax
  error.
...
\begin{frame}[containsverbatim]
  ...
  Nevertheless, the GNU C pre-processor introduced an extension for
  this common problem.
  ...
  argument is empty and preceded by a comma; then the GNU C preprocessos will
  remove the comma to make the syntax correct.
\end{frame}
...
%% bibliography: GNU c-preprocessor info, queue.h, bpt.h
