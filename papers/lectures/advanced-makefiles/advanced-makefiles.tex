...
%% last update   Tue Sep  6 16:11:07 2005   mycure
%%
...
\begin{frame}
  ...
  \begin{Example}
    \verbatiminput{examples/makefile-common.li}
  \end{Example}
...
\begin{frame}
  ...
  \begin{Example}
    \verbatiminput{examples/makefile-complete.li}
  \end{Example}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{5cm}
      \begin{Example}
        \verbatiminput{examples/makefile-directives-1.li}
      \end{Example}

    \column{5cm}
      \begin{Example}
        \verbatiminput{examples/makefile-directives-2.li}
      \end{Example}
...
\begin{frame}
  ...
  \begin{Example}
    \verbatiminput{examples/makefile-conditional-parts.li}
  \end{Example}
...
\begin{frame}
  ...
  \begin{Example}
    \verbatiminput{examples/implicit-rules-1.li}
  \end{Example}

  \begin{Example}
    \verbatiminput{examples/implicit-rules-2.li}
  \end{Example}
...
\begin{frame}
  ...
  \begin{Example}
    \verbatiminput{examples/makefile-implicit-rules.li}
  \end{Example}
...
\begin{frame}
  ...
  \begin{Example}
    \verbatiminput{examples/makefile-target-grouping.li}
  \end{Example}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{7cm}
      \begin{Example}
        \verbatiminput{examples/makefile-implicit-rules-redefinition.li}
      \end{Example}

    \column{4cm}
      \begin{Example}
        \verbatiminput{examples/implicit-rules-redefinition.li}
      \end{Example}
...
cool mais si bcp d includes inclus dans d autres includes, c est complique
de faire en sorte de tous les mettre
